...
| # | Problem | Description | Key Idea | C++ | Java | LeetCode | GFG | LC Done | GFG Done |
|---|---------|-------------|----------|-----|------|----------|-----|---------|----------|
...
| 10 | Largest and Second Largest | Find the largest and second largest numbers in a list. | Scan once while tracking the top two values | [✓](./C++/004%20Module/003LargestSecondLargest.cpp) | [✓](./Java/004%20Module/LargestSecondLargest.java) | - | - | - | - |
| 11 | Multiplication Table | Display the multiplication table of a positive number. | Loop through 1 to 10 and print products | [✓](./C++/004%20Module/004multiplicationTable.cpp) | [✓](./Java/004%20Module/MultiplicationTable.java) | - | - | - | - |
...
| 13 | Lowest Fraction | Convert a fraction into its lowest terms. | Divide numerator and denominator by their GCD | [✓](./C++/004%20Module/006lowestFraction.cpp) | [✓](./Java/004%20Module/LowestFraction.java) | - | - | - | - |
...
| 15 | Triangle Number Pattern | Print a triangle number pattern for a given size. | Use nested loops to print row-wise patterns | [✓](./C++/004%20Module/008triangleNumber.cpp) | [✓](./Java/004%20Module/TriangleNumber.java) | - | - | - | - |
...
| 17 | Merge Two Sorted Arrays | Merge two sorted arrays into a single sorted array. | Use two pointers to traverse both arrays and build merged result | [✓](./C++/005%20Module/001MergeTwoSortedArrays.cpp) | X | [LeetCode](https://leetcode.com/problems/merge-sorted-array/) | [GFG](https://www.geeksforgeeks.org/problems/merge-two-sorted-arrays5135/1) | [ ] | [ ] |
| 18 | Elements Less Than | Count or find elements that are less than a given value. | Single pass to filter and collect matching elements | [✓](./C++/005%20Module/002ElementsLessThan.cpp) | X | [LeetCode](https://leetcode.com/problems/how-many-numbers-are-smaller-than-the-current-number/) | [GFG](https://www.geeksforgeeks.org/problems/counting-elements-in-two-arrays/1) | [ ] | [ ] |
| 19 | Search | Check whether a key is present in an array. | Linear scan until the key is found | [✓](./C++/005%20Module/003Search.cpp) | X | - | [GFG](https://www.geeksforgeeks.org/problems/linear-search/1) | - | [ ] |
| 20 | Max and Min | Find the largest and smallest elements of an array. | Track running minimum and maximum in one pass | [✓](./C++/005%20Module/004MaxAndMin.cpp) | X | - | [GFG](https://www.geeksforgeeks.org/problems/find-minimum-and-maximum-element-in-an-array4428/1) | - | [ ] |
| 21 | Odd Even | Separate array elements into odd and even groups. | Partition values by parity while preserving order | [✓](./C++/005%20Module/005OddEven.cpp) | X | [LeetCode](https://leetcode.com/problems/sort-array-by-parity/) | [GFG](https://www.geeksforgeeks.org/problems/segregate-even-and-odd-numbers4629/1) | [ ] | [ ] |
| 22 | Search Key | Find the index of a key in an array. | Scan once and report the first matching index | [✓](./C++/005%20Module/006SearchKey.cpp) | X | - | [GFG](https://www.geeksforgeeks.org/problems/search-an-element-in-an-array-1587115621/1) | - | [ ] |


---

**Total Problems:** 22 | **C++:** 22 | **Java:** 16
